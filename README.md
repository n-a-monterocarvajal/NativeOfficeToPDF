...
[![Último release](https://img.shields.io/github/v/release/n-a-monterocarvajal/NativeOfficeToPDF?label=release&color=success)](https://github.com/n-a-monterocarvajal/NativeOfficeToPDF/releases/latest)
...
[![Compilación distribuible](https://github.com/n-a-monterocarvajal/NativeOfficeToPDF/actions/workflows/build-package.yml/badge.svg)](https://github.com/n-a-monterocarvajal/NativeOfficeToPDF/actions/workflows/build-package.yml)\
[![Windows 10 | 11](https://img.shields.io/badge/Windows-10%20%7C%2011-0078D4)](#requisitos)
...
El PDF queda junto al archivo original, con el mismo nombre. Si ya existía, pregunta
