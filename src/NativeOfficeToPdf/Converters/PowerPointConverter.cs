        ...
        try
        {
            ...
            try
            {
                presentation.InvokeNamed(
                    ...
                    // PrintRange espera "Nothing" (VT_DISPATCH con puntero nulo) cuando no se usa un
                    // rango. Con enlace tardío, un simple `null` de .NET no se marshalla como
                    // VT_DISPATCH de forma fiable (se comporta igual que omitir el parámetro o pasar
                    // Type.Missing: ambos producen DISP_E_TYPEMISMATCH, 0x80020005). DispatchWrapper
                    // fuerza el VARIANT correcto.
                    ("PrintRange", new DispatchWrapper(null)),
